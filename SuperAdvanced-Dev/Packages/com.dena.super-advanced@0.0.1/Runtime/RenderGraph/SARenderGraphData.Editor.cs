...
{
#if UNITY_EDITOR
    public partial class SARenderGraphData
    {
        ...
        internal class CreateRenderGraphDataAsset : EndNameEditAction
        {
            ...
            {
                //Create asset
                SARenderGraphData data = CreateInstance<SARenderGraphData>();
        ...
        [MenuItem("Assets/Create/Rendering/Super Advanced Render Pipeline/SA Render Graph Data Asset", priority = CoreUtils.Sections.section2 + CoreUtils.Priorities.assetsCreateRenderingMenuPriority + 1)]
        static void Create()
        {
            ...
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0, CreateInstance<CreateRenderGraphDataAsset>(),
                "New SA Render Graph Data Asset.asset",null, null);
        }
        
        public SARenderGraphData()
        {
            InitGUID();
        }
