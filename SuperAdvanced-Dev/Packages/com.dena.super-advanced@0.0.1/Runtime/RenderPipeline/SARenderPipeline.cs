...
{
    public partial class SARenderPipeline : RenderPipeline
    {
        /// <summary>
        ...
        public static SARenderPipelineAsset asset
        {
            get => GraphicsSettings.currentRenderPipeline as SARenderPipelineAsset;
        }
        ...
        readonly SARenderPipelineAsset m_Asset;
        ...
        public struct RenderRequest
        {
            ...
            public SARenderGraphData.NodeType nodeType;
        ...
        public SARenderPipeline(SARenderPipelineAsset asset)
        {
                ...
                /// render all the render request
                    using (new ProfilingScope(null, ProfilingSampler.Get(ProfileId.FlowPipelineRenderAllRenderRequest)))
                    {
                        ...
                        for (int i = 0; i < renderRequests.Count; ++i)
                        {
                            ...
                            using (new ProfilingScope(cmd, renderRequest.saCamera.profilingSampler))
                            {
                            ...
                            EndCameraRendering(renderContext, renderRequest.saCamera.camera);
        ...
        bool TryCalculateFrameParameters(
            Camera camera,
            out SAAdditionalCameraData additionalCameraData,
            out ScriptableCullingParameters cullingParams,
            out SARenderGraphData currentGraphData,
            out SACamera saCamera
        )
        {
            // First, get aggregate of frame settings base on global settings, camera frame settings and debug settings
            // Note: the SceneView camera will never have additionalCameraData
            additionalCameraData = SAUtility.TryGetAdditionalCameraDataOrDefault(camera);
            cullingParams = default;
            
            currentGraphData = additionalCameraData.renderGraphData;
            
            saCamera = SACamera.GetOrCreate(camera);
            // From this point, we should only use frame settings from the camera
            saCamera.Update(this);
        ...
        internal GraphicsFormat GetColorBufferFormat(SARenderGraphData.TextureBufferNode textureBufferNode)
        {
