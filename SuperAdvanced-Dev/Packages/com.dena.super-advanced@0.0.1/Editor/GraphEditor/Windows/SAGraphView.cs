...
{
    public partial class SAGraphView : GraphView, IDisposable
    {
        private SAGraphEditorWindow m_EditorWindow;

        private SAGraphSearchWindow m_SearchWindow;

        public SAGraphView(SAGraphEditorWindow editorWindow)
        {
        ...
        private void AddSearchWindow()
        {
            ...
            {
                m_SearchWindow = ScriptableObject.CreateInstance<SAGraphSearchWindow>();
