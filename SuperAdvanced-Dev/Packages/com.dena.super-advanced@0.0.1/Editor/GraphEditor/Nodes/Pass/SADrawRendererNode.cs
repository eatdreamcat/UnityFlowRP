...
{
    public class SADrawRendererNode : SANodeBase
    {
        ...
        private static readonly List<FoldoutDisplay> FoldoutList = new List<FoldoutDisplay>()
        {
            new FoldoutDisplay()
            {
                ...
                portContraintedType = typeof(SACullingParameterNode),
                indentValue = Indent
            },
            ...
            new FoldoutDisplay()
            {
                ...
                suffix = " Preview",
                needReferencePort = true,
                portContraintedType = typeof(SARenderStateNode),
                indentValue = Indent
            },
            ...
            new FoldoutDisplay()
            {
                ...
                suffix = " Preview",
                needReferencePort = true,
                portContraintedType = typeof(SARenderMaterialNode),
                indentValue = Indent
            },
            ...
            new FoldoutDisplay()
            {
                ...
                suffix = " Preview",
                needReferencePort = true,
                portContraintedType = typeof(SACameraParameterNode),
                indentValue = Indent
            },
        };
        ...
        public SARenderGraphData.DrawRendererNode RenderRequest => (SARenderGraphData.DrawRendererNode)m_GraphNodeData;
        ...
        private void DrawCullingBlock(ChangeEvent<bool> evt)
        {
            ...
            if (isExpended)
            {
                if (foldoutBlock.assignIn != null && !string.IsNullOrEmpty(RenderRequest.culling))
                {
                    ...
                    var previewElement = SAElementUtilities.CreateCullingParameter(
        ...
        private void DrawStateBlock(ChangeEvent<bool> evt)
        {
            ...
            if (isExpended)
            {
                if (foldoutBlock.assignIn != null && !string.IsNullOrEmpty(RenderRequest.state))
                {
                    ...
                    var previewElement = SAElementUtilities.CreateStateParameter(stateParameter, true);
                    previewElement.style.left = Indent * 2;
        ...
        private void DrawMaterialBlock(ChangeEvent<bool> evt)
        {
            ...
            if (isExpended)
            {
                if (foldoutBlock.assignIn != null && !string.IsNullOrEmpty(RenderRequest.material))
                {
                    ...
                    var previewElement = SAElementUtilities.CreateMaterialParameter(materialParameter, 
                        null, null, true);
                    previewElement.style.left = Indent * 2;
                    foldoutBlock.block.Add(previewElement);
                }
        ...
        private void DrawCameraBlock(ChangeEvent<bool> evt)
        {
            ...
            if (isExpended)
            {
                if (foldoutBlock.assignIn != null && !string.IsNullOrEmpty(RenderRequest.camera))
                {
                    ...
                    var previewElement = SAElementUtilities.CreateCameraParameter(cameraParameter.fov, null,
