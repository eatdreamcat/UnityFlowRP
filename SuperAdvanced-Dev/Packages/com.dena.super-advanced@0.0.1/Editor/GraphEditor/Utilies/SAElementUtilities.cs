...
{
    public static class SAElementUtilities
    {
            ...
            ListViewReorderMode reorderMode = ListViewReorderMode.Animated, bool showFoldoutHeader = true, bool showAddRemoveFooter = true) where ItemElement : VisualElement
        {
            ...
            if (showFoldoutHeader)
            {
                ...
                var arraySize = CreateIntegerField(listView.itemsSource.Count, null, evt =>
                {
                    ...
                    {
                        var count = evt.newValue - itemCount;
                        for (int i = 0; i < count; ++i)
                        {
                            listView.itemsSource.Add(data[data.Count-1]);
                        }
        ...
        {
            allowedNodeType = allowedNodeType == null ? typeof(SANodeBase) : allowedNodeType;
        ...
        public static VisualElement CreateMaterialParameter(
            SARenderGraphData.MaterialParameterNode materialParameter,
        ...
        public class BlendStateElement : VisualElement
        {
            ...
            private SARenderGraphData.BlendStateData m_BlendStateData;
            public void Initialize(SARenderGraphData.BlendStateData tempblendStateData)
            {
            ...
            public void Update(SARenderGraphData.BlendStateData blendStateData)
            {
                if (!m_hasInitialized) return;
        ...
        public static BlendStateElement CreateBlendStateParameter(SARenderGraphData.BlendStateData blendStateData)
        {
        ...
        public static VisualElement CreateStateParameter(SARenderGraphData.RenderStateNode stateParameter, bool isReadonly = false)
        {
            ...
            var tempData = new SARenderGraphData.BlendStateData();
           
            var blendStatesListView = CreateListView<SARenderGraphData.BlendStateData, BlendStateElement>(stateParameter.blendStateSettings.blendStates, "Blend States", () =>
            {
            ...
            }, (element, i) =>
            {
                stateParameter.blendStateSettings.blendStates[i] = stateParameter.blendStateSettings.blendStates[i] is null
                    ? new SARenderGraphData.BlendStateData()
