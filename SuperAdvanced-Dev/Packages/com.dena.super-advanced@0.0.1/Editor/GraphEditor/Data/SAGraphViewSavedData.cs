...
namespace UnityEditor.Rendering.SuperAdvanced
{
     ...
     *   
     */
    public class SAGraphViewSavedData : ScriptableObject
    {
        [Serializable]
        ...
        [Serializable]
        public sealed class NodeDataDictionary : SASerializedDictionary<string, NodeData> { }
        [Serializable]
        public  sealed class GroupDataDictionary : SASerializedDictionary<string, GroupData> { }
        ...
        {
            [HideInInspector]
            private SAGraphViewSavedData m_So;
            [SerializeField]
            ...
            public GraphViewData(SAGraphViewSavedData so, NodeDataDictionary nodeMap, GroupDataDictionary groupMap)
            {
                m_So = so;
                m_NodeMap = nodeMap;
                m_GroupMap = groupMap;
        ...
        internal sealed class GraphViewDataDictionary : SASerializedDictionary<string, GraphViewData> { }
        
        [Serializable]
        internal sealed class GraphViewTransformDictionary : SASerializedDictionary<string, ViewTransformData> { }
        ...
        public void CreateViewDataIfNotExisit(string graphGUID, ViewTransformData viewTransformData)
        {
            ...
            if (dirty)
            {
                SAAssetsUtility.SaveAsset(this);
            }
