...
{
    public class FRPSerializableDictionary
    {
    }

    [Serializable]
    public class FRPSerializableDictionary<TKey, TValue> : FRPSerializableDictionary, IDictionary<TKey, TValue>, ISerializationCallbackReceiver
    {
        [SerializeField]
        ...
        public FRPSerializableDictionary()
        {
            _keyPositions = new Lazy<Dictionary<TKey, uint>>(MakeKeyPositions);
        }

        public FRPSerializableDictionary(IDictionary<TKey, TValue> dictionary)
        {
            _keyPositions = new Lazy<Dictionary<TKey, uint>>(MakeKeyPositions);
